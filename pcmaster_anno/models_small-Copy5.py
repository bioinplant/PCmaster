...
class PCMA_MYGO_RC_1D(nn.Module):
    def __init__(self, num_classes=2, input_len=16384, base_channels=64, blocks=4, dropout=0.3):
        super().__init__()
        self.proj = nn.Conv1d(1, base_channels, kernel_size=7, stride=4, padding=3, bias=False)

...
def train_sgd_svm_with_scaler_and_calibration(memmap_path: str,
    ...
    import os
    meta_train = pd.read_csv(metadata_csv)  # subset (train)
    ...
    classes = sorted(meta_train["celltype_int"].unique().tolist())

    scaler = StandardScaler()
    # fit scaler in streaming batches on train_indices
    ...
    # calibration using validation subset if requested

...
from .models_small import PCMA_MYGO_RC, PCMA_MYGO_RC_1D, PCMA_MYGO_FC, PCMA_MYGO_SA
...
def predict_torch_model(model_or_path,
    ...
    if isinstance(model_or_path, str):
        ...
        if mode == "rc":
            ...
            model = PCMA_MYGO_RC_1D(num_classes=n_classes, input_len=16384, dropout=cfg.rc_dropout)
        elif mode == "fc":
            n_feat_fc = int(info.get("n_features_fc", info.get("n_features_total", None)))
